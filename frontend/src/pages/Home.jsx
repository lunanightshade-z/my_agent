  ...
  return (
    <div className="min-h-[calc(100vh-6rem)]">
      ...
      >
        ...
        >
          {/* 背景光点 */}
          <div className="absolute w-96 h-96 bg-gradient-to-br from-elite-gold/30 via-elite-champagne/30 to-elite-copper/30 rounded-full blur-3xl animate-pulse" />
          ...
          >
            ...
            {/* 内层渐变 */}
            <div className="absolute inset-4 rounded-full bg-gradient-to-br from-elite-gold/40 via-elite-champagne/40 to-elite-copper/40" />

            {/* 中心光点 */}
            <motion.div
              className="absolute top-1/2 left-1/2 w-16 h-16 bg-gradient-to-r from-elite-gold to-elite-champagne rounded-full blur-xl"
              animate={{
                scale: [1, 1.2, 1],
                opacity: [0.5, 1, 0.5],
              }}
            ...
            {/* 环绕圆环 */}
            <motion.div
              className="absolute inset-0 rounded-full border border-transparent bg-gradient-to-r from-elite-gold via-transparent to-elite-copper opacity-50"
              animate={{
                rotate: 360,
              }}
              transition={{
        ...
        >
          {[
            ...
            return (
              ...
              >
                {/* 图标容器 */}
                <div className={`w-16 h-16 rounded-2xl ${colors.bg} flex items-center justify-center mb-6 transition-shadow duration-300`}>
                ...
                <motion.div
                  ...
                  style={{
                    background: `radial-gradient(circle, ${
                      feature.color === 'gold'
                        ? 'rgba(212, 175, 55, 0.4)'
                        : feature.color === 'champagne'
                        ? 'rgba(232, 217, 195, 0.4)'
                        : 'rgba(184, 115, 51, 0.4)'
                    }, transparent)`,
                  }}
                />
